...
<body>
    ...
    <b> <h1 id="congregacion_title" class="congregacion_title">  <b>Congregacion <?php echo $congregacion_title?> </b> </h1>
    ...
    <div class="container">
        <div class="image-container">
            ...
            <div class="image" id="cartas">
                ...
                <img id="img_4_d" src="" alt="No hay mas cartas que mostrar">
            </div>
            ...
            <div class="image" id="cartas2">
                <h2 class="title" id="cartas2_title" > Cartas </h2>
                <img id="img_4_d" src="" alt="No hay mas cartas que mostrar">
            </div>
